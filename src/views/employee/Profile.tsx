...
import { Mail, Shield, User, MapPin, Building, Key, Award, Clock, Loader2, Eye, EyeOff } from "lucide-react";
...
export default function EmployeeProfile() {
  ...
  if (loading) {
    return (
      <AppShell role="employee" title="My Profile" subtitle="Manage your personal information and preferences.">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_350px] max-w-6xl mx-auto">
        <div className="space-y-6">
          ...
          <section className="rounded-xl border border-border bg-card shadow-card overflow-hidden">
            <div className="h-32 bg-gradient-to-r from-primary/10 via-primary/5 to-transparent border-b border-border relative">
            ...
            <div className="px-8 pb-8 pt-0 relative sm:flex sm:items-end sm:justify-between">
              <div className="sm:flex sm:items-end sm:gap-6">
                <Avatar className="h-24 w-24 border-4 border-card shadow-lg -mt-12 bg-background relative z-10">
                  <AvatarFallback className="bg-accent text-foreground text-2xl font-bold">
            ...
            <form className="grid gap-6 md:grid-cols-2" onSubmit={handleProfileUpdate}>
              ...
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  ...
                  <Input placeholder="Remote - India" className="h-10 pl-9 bg-secondary/20 shadow-xs" />
                </div>
              </div>
